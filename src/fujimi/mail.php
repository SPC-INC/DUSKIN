...
$to = "fujimi223@mbe.nifty.com,ohri.ishizuka@mbr.nifty.com";
...
$subject = "★要対応★LPよりお問い合わせ：連絡をお願いします。";
...
$refrom_name = "ダスキン不二美メリーメイド";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ダスキン不二美メリーメイド】お問い合わせありがとうございます。";
...
この度は、ダスキン不二美メリーメイドにお問い合わせいただきまして誠にありがとうございます。

下記のようにお問い合わせを受付いたしました。
担当者より、2～3営業日以内に折り返しご連絡させていただきます。

お急ぎのところ誠に恐れ入りますが、今しばらくお待ちくださいますようお願いいたします。
...
<?php
                ...
                header("Location: " . $thanksPage . "?send='1'");
            }
        }
        ...
        function mailToAdmin($arr, $subject, $mailFooterDsp, $mailSignature, $encode, $confirmDsp)
        {
            $adminBody = "" . $subject . "\n\n";
            $adminBody .= "＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
            $adminBody .= '下記のお客様よりお問い合わせをいただきました。';
            $adminBody .= postToMail($arr); //POSTデータを関数からセット
            $adminBody .= '受付日より2～3営業日以内でのご連絡をお願いいたします。';
            $adminBody .= "\n＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n";
