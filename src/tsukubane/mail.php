...
$to = "Chiemi_furuya@d-tsukubane.com";
...
$from = "Chiemi_furuya@d-tsukubane.com";
...
$refrom_name = "ダスキン筑波嶺メリーメイド";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ダスキン筑波嶺メリーメイド】お問い合わせありがとうございます。";
...
この度は、ダスキン筑波嶺メリーメイドにお問い合わせいただきまして誠にありがとうございます。
