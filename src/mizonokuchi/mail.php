...
$to = "furuya@duskin-mizonokuchi.com";
...
$from = "furuya@duskin-mizonokuchi.com";
...
$refrom_name = "ダスキン溝口メリーメイド";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ダスキン溝口メリーメイド】問い合わせありがとうございます。";
...
この度は、ダスキン溝口メリーメイドにお問い合わせいただきまして誠にありがとうございます。
