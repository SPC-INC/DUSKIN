                    ...
                    <div class="topFaqItemWrap">
                        <?php $list = array(
                            ...
                            array(
                                ...
                                'ans' => 'お掃除おまかせサービスと家事おてつだいサービスでは、お留守の間にサービスを実施することも可能です。ただし、調理につきましては在宅していただく必要がございます。',
                            ),
                            array(
                                'ques' => 'どんな人が来てくれるの？',
                                'ans' => 'ダスキン本部が定める研修を受けたスタッフがお伺いいたします。ご希望のメニューによってはスタッフを固定することも可能です。',
                            ),
                            array(
                                'ques' => 'サービスは、土日、祝日、夜間も来てくれるの？',
                                'ans' => 'サービス実施日については、お見積り時にご相談させていただきます。
                                <br>※基本的には、月～金曜日の午前または午後のサービスです。
                                <br>※本ページのダスキン宮本北メリーメイドでは土曜・祝日のサービスにも対応しております。',
                            ),
                            array(
                                'ques' => '申込み後キャンセルした場合、キャンセル料は発生しますか？',
                                'ans' => 'サービス日の前日・当日のキャンセルの場合、キャンセル料をいただいております。',
                            ),
                        );
                        $num = 0;
                        foreach ($list as $key => $value) {
            ...
            <section class="topContact" id="topContact">
                <div class="wrap sp-wrap">
                    ...
                    <div class="topContactForm topContactForm--blue js-form show" id="form-clean">
                        <form action="<?php echo HOME; ?>miyamotokita/mail.php" method="post">
