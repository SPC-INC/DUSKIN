...
$refrom_name = "ダスキン宮本北メリーメイド";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "【ダスキン宮本北メリーメイド】お問い合わせありがとうございます。";
...
この度は、ダスキン宮本北メリーメイドにお問い合わせいただきまして誠にありがとうございます。
